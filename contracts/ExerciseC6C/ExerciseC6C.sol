...
contract ExerciseC6C {
    ...
    function updateEmployee(string id, uint256 sales, uint256 bonus) public {
    ...
    function calculateBonus(
        uint256 sales
    ) internal view requireContractOwner returns (uint256) {
        if (sales < 100) {
    ...
    function authorizeContract(
        ...
        require(appContract != address(0x0), "Invalid address.");
